...
def parsear_factura(contenido):
    ...
    if raiz.tag != _RAIZ_FACTURA:
        raise FacturaInvalida("el XML no es una factura electrónica UBL (se esperaba <Invoice>).")
    ...
    return FacturaParseada(
        cufe=cufe,
        numero=_texto(raiz, "cbc:ID", "el número de factura"),
